 ...
 * It is used in conjunction with the `DomainBuilder` to define runtime settings, resource allocation, and event-driven integration for each Lambda.
 * 
...
export class LambdaBuilder {
   ...
   * @param path The path of the API route (e.g., `/accounts`).
   * @param method The HTTP method for the route (e.g., `GET`, `POST`).
   * @returns The current instance for method chaining.
   */
  public exposedVia(path: string, method: string): this {
    this.domainBuilder.addApiRoute(path, method, this.config.name);
    return this;
  }
